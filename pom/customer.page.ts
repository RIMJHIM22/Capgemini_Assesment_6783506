...
const jsondata1=fs.readFileSync(path.join(__dirname,"../test_data/customer.json"),"utf-8")
const CustmActon=JSON.parse(jsondata1)
const jsondata2=fs.readFileSync(path.join(__dirname,"../test_data/create_acc.json"),"utf-8")
